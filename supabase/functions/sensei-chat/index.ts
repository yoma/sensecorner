...
async function reserveAiRateSlot(
  userId: string,
  mode: "general" | "hub" | "gateway" | "gateway_summary",
  ...
  else if (purposeSupported && mode === "gateway") logRow.purpose = "gateway";
  else if (purposeSupported && mode === "gateway_summary") logRow.purpose = "gateway_summary";
